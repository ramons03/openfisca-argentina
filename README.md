...
These elements are described in different folders. All the modelling happens within the `openfisca_argentina` folder.
...
```sh
pip install openfisca_argentina
```
...
```sh
git clone https://github.com/openfisca/openfisca-argentina.git
cd openfisca-argentina
...
Substitute your package's country name for `openfisca_argentina` below:
